...
// 자바 스크립트 첫 번째 버전부터 있었던 버그 -> 기존 코드에 영향을 줄 수 있어서 수정이 안 됨. 
...
test = function(){}; // 함수
console.log(typeof test); //function 로 표시해줌

/* 
[동적 타입 언어 단점을 보완하기 위해 유의할 점]

1. 변수는 꼭 필요한 경우에 한해 제한적으로 사용한다.
2. 변수의 유효 범위(스코피)를 최대한 좁게 만든다.
3. 전역 변수를 지양한다
4. 변수보다 상수를 사용해 값의 변경을 억제한다.
5. 변수명을 통해 변수의 목적이나 의미를 잘 파악할 수 있게 한다.
 */
