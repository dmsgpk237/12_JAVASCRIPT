...
개발자가 의도적으로 값의 타입을 변환하는 것을 명시적 타입변환(explicit coercion)이라고 하며
자바 스크립트 엔진에 의해 암묵적으로 자동 변환되는 것을 암묵적 타입변환(implicit coercion)이라고 한다.
...
// simbol 타입은 문자열로 변경될 수 없어 type error가 발생한다.
